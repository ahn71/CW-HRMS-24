<%@ Page Title="" Language="C#" MasterPageFile="~/personnel_NestedMaster.master" AutoEventWireup="true" CodeBehind="increment_sheet_v2.aspx.cs" Inherits="SigmaERP.personnel.increment_sheet_v2" %>
               ...
               <div style="margin-top: 5px">
                   <ul>
                       ...
                       <li> <a class="seperator" href="#"></a>/</li>                  
                        ...
                        <li> <a class="seperator" href="#"></a>/</li>
                       <li> <a href="#" class="ds_negevation_inactive Pactive">Increment & Promotion Sheet</a></li>
                   </ul>               
             </div>
...
<asp:UpdatePanel ID="uplMessage" runat="server" >
    ...
    <asp:UpdatePanel runat="server" ID="up1" UpdateMode="Conditional">
        ...
        <div class="main_box_header PBoxheader">
            <h2>Increment & Promotion Sheet</h2>
        </div>
    	<div class="main_box_body Pbody">
            <div class="main_box_content">
                        <div class="punishment_against">
                            ...
                            <center>
                                 <asp:RadioButtonList runat="server" ClientIDMode="Static" ID="rblReportType" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rblReportType_SelectedIndexChanged">
                                <asp:ListItem Selected="True" Value="increment">Increment</asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <asp:RadioButtonList ID="rbEmpList" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rbEmpList_SelectedIndexChanged" >
                                           ...
                                           <asp:ListItem Value="00" Selected="false" >Individual</asp:ListItem>

                                       </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr runat="server" id="trIncrementType">
                                    <td>
                                        Increment Type
                                    </td>
                                    <td>
                                        <asp:RadioButtonList runat="server" ID="rblIncrementType" RepeatDirection="Horizontal">
                                            <asp:ListItem Value="0" Selected="True">All</asp:ListItem>
                        ...
                        <div class="punishment_button_area">
                            <table class="emp_button_table">
                                <tbody>
                                    <tr>
                                        <th>
                                            <asp:Button ID="btnpreview" CssClass="Pbutton" runat="server" ClientIDMode="Static" Text="Increment Sheet" OnClick="btnpreview_Click"  Visible="false"/></th>
                                        <th>
                                            <th>
                                            <asp:Button ID="btnPreviewDetails" CssClass="Pbutton" runat="server" ClientIDMode="Static" Text="Increment Sheet Details" OnClick="btnPreviewDetails_Click" Visible="false" /></th>
                                        

                                           <th>
                                            <asp:Button ID="bntExcel" CssClass="Pbutton" Text="Preview"  runat="server"  OnClick="bntExcel_Click"/></th>
                                        <th>
