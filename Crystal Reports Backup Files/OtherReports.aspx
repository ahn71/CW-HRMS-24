<%@ Page Title="" Language="C#" MasterPageFile="~/personnel_NestedMaster.master" AutoEventWireup="true" CodeBehind="OtherReports.aspx.cs" Inherits="SigmaERP.personnel.OtherReports" %>
...
<%--                            <asp:RadioButtonList  runat="server" ID="rblReportType"  ClientIDMode="Static" RepeatDirection="Horizontal" Font-Bold="true">
                            ...
                            <asp:DropDownList ID="ddlReportType" ClientIDMode="Static" CssClass="form-control select_width" runat="server">
                                ...
                                <asp:ListItem Value="ShowCause_letter">Show Cause Letter</asp:ListItem>
                                <asp:ListItem Value="promotion_letter">Promotion Letter</asp:ListItem>
                                <asp:ListItem Value="incrementletter">Increment Letter</asp:ListItem>
