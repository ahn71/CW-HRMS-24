<%@ Page Title="" Language="C#" MasterPageFile="~/attendance_nested.master" AutoEventWireup="true" CodeBehind="WeekendInfoReport.aspx.cs" Inherits="SigmaERP.attendance.WeekendInfoReport" %>
            ...
            <div class="ds_nagevation_bar">
                <ul>
                   ...
                   <li><a href="<%=  Session["__topMenu__"] %>">Attendance</a></li>
                    <li>/</li>
                    <li><a href="#" class="ds_negevation_inactive Mactive">Weekend Info Report</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<h1  runat="server" visible="false" id="WarningMessage"  style="color:red; text-align:center"></h1>
                    ...
                    <table runat="server" visible="true" id="tblGenerateType" class="division_table_leave1">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <asp:TextBox ID="txtFromDate" ClientIDMode="Static" runat="server" CssClass="form-control text_box_width" autocomplete="off"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList class="rb" ID="rblReportType" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="empwise" Selected="True">Emp. Wise</asp:ListItem>
