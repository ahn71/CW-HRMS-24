<%@ Page Title="Salary Processing" Language="C#" MasterPageFile="~/payroll_nested.master" AutoEventWireup="true" CodeBehind="salary_processing.aspx.cs" Inherits="SigmaERP.payroll.salary.salary_processing" %>
                ...
                <asp:UpdatePanel ID="up2" runat="server" UpdateMode="Conditional">
                        <Triggers>                           
                           ...
                           <%-- <asp:AsyncPostBackTrigger ControlID="btnGenerate" />--%>
                            ...
                            <asp:AsyncPostBackTrigger ControlID="rblProcessOn" />                           
                            <asp:AsyncPostBackTrigger ControlID="ddlEmpCardNo" />                           
                        </Triggers>
                        <ContentTemplate>
                           <div class="bonus_generation" style="width: 66%; margin: 0px auto;">   
                              
                                <table runat="server" visible="true" id="tblGenerateType"  style="width:80%; margin:0px auto"> 
                                    ...
                                    <tr>
                                     ...
                                     <tr>                          
                                        ...
                                        <td>
                                            <asp:RadioButtonList ID="rbGenaratingType" runat="server"  AutoPostBack="false" ClientIDMode="Static" onChange="EnableControl(this);" RepeatDirection="Horizontal">
                                                <asp:ListItem Selected="True" Value="0">Full</asp:ListItem>
                            ...
                            <div  style="width: 61%; margin: 0px auto; overflow: hidden;display:none">
                                <div style="width: 50%; margin: 0px auto; overflow: hidden">                                  
                                    ...
                                    <asp:Button ID="Button3" runat="server" Text="Close" PostBackUrl="~/payroll_default.aspx" CssClass="Pbutton" Style="float: left"  Visible="false"/>

                                    <asp:Button ID="btnBDTNoteGenerate" runat="server" Text="BDT Note Generate" CssClass="Pbutton" Style="float: left; width: 166px;" OnClientClick="return validation();" OnClick="btnBDTNoteGenerate_Click" Visible="false" /><br />
                                </div>
                            </div>
                            <br />
                        <hr />
