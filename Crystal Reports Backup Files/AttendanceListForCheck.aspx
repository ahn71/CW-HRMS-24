<%@ Page Title="" Language="C#" MasterPageFile="~/attendance_nested.master" AutoEventWireup="true" CodeBehind="AttendanceListForCheck.aspx.cs" Inherits="SigmaERP.attendance.AttendanceListForCheck" %>
        ...
        <div style="overflow: hidden; margin-bottom: 5px; border-bottom: 1px solid #ddd;">
            ...
            <%--<h3 class="emp_header_left">--%>
             <h2 class="emp_header_left" style="float: left; width:78%;">
                <p style="text-shadow: 5px 5px 5px rgb(0, 0, 0); font-size: 20px; font-weight: 500; text-align: center;">Attendance List</p>
        ...
        <div style="width: 100%;">
             <table style="margin: 0 0 5px 6px; border-collapse: collapse;" width="99%">
                     ...
                     <tr>
                         ...
                         <td>
                             <asp:DropDownList ID="ddlDepartmentName" CssClass="form-control inline_form_text_box_width" runat="server"  ></asp:DropDownList>
                         </td>                  
                     ...
                     <asp:GridView HeaderStyle-BackColor="#2B5E4E" HeaderStyle-Height="28px" ID="gvAttendanceList" runat="server" AutoGenerateColumns="false"  HeaderStyle-ForeColor="White" HeaderStyle-Font-Bold="true" HeaderStyle-Font-Size="14px" AllowPaging="true" PageSize="40" Width="100%" DataKeyNames="EmpId,EmpCardNo,AttDate,AttStatus,InTime,OutTime,EmpType,EmpName,StateStatus" OnPageIndexChanging="gvAttendanceList_PageIndexChanging" OnRowCommand="gvAttendanceList_RowCommand" OnRowDataBound="gvAttendanceList_RowDataBound"  >
                         <PagerStyle CssClass="gridview" />
                          <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-VerticalAlign="Middle"  Visible="false">
                                        <HeaderTemplate>
                                            Delete
                                        </HeaderTemplate>
                                        <ItemTemplate >
