<%@ Page Title="" Language="C#" MasterPageFile="~/payroll_nested.master" AutoEventWireup="true" CodeBehind="loan_monthly_setup.aspx.cs" Inherits="SigmaERP.payroll.loan_monthly_setup" %>
        ...
        <div class="main_box_body Pbody">
           ...
           <%-- <br />
            <br />--%>
               <hr />
            <br />
              <asp:GridView ID="gvAdvaceList" runat="server" AutoGenerateColumns="false" HeaderStyle-Height="26px" HeaderStyle-Font-Bold="false" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#ffa500" DataKeyNames="SL,LoanID,EmpID,CompanyID,MonthID" Width="100%" OnRowCommand="gvAdvaceList_RowCommand">
            <Columns>
