    ...
    <div class="col-lg-12" style="margin-top:10%">
             <div class="row">
                 ...
                 <div runat="server" id="divHolidayComp" class=" col-md-2" title="All Holiday Setup">
                        <a class="ds_leave_Basic_Text" href="/leave/holyday1.aspx"><img class="image_width_for_module" src="images/common/qualification.ico" /><br />Holiday Setup </a>
                 </div>
               ...
               <div class="row">
                ...
                <div runat="server" id="divEarnLeaveGeneration"  class=" col-md-2" title="Earn Leave Generate">
                 ...
                 <div  runat="server" id="divEarnLeaveReport" class=" col-md-2" title="Earn Leave Report">
