            ...
            try
            {
                ...
                foreach (DataRow dtRow in dt.Rows)
                {
                    ...
                    int nDec = int.Parse(dtRow["nDec"].ToString());                    
                        getSQLCMD = " select  EmpID,Month,PreMonthDays,NextMonthDays from Earnleave_MonthlyInfo where EmpID='" + dtRow["EmpID"] + "' and Month>='" + startDate + "' and  Month<='" + endDate + "'  order by Month ";
