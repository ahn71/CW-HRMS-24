<%@ Page Title="OT Payment" Language="C#" MasterPageFile="~/payroll_nested.master" AutoEventWireup="true" CodeBehind="ot_payment.aspx.cs" Inherits="SigmaERP.payroll.salary.ot_payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">    
        ...
        <div class="col-md-12">
            <div class="ds_nagevation_bar">
                <ul>
                    ...
                    <li><a class="seperator" href="#"></a>/</li>
                    <li><a href="#" class="ds_negevation_inactivez Pactive">Monthly Overtime Payment</a></li>
                </ul>
            </div>
        </div>
    </div>
   ...
   <div class="main_box Mbox">
        <div class="main_box_header PBoxheader">
            <h2>Monthly Overtime Payment</h2>
        </div>
