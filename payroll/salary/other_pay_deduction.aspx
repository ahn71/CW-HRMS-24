<%@ Page Title="" Language="C#" MasterPageFile="~/payroll_nested.master" AutoEventWireup="true" CodeBehind="other_pay_deduction.aspx.cs" Inherits="SigmaERP.payroll.salary.other_pay_deduction" %>
        ...
        <div class="col-md-12">
            <div class="ds_nagevation_bar">
                <ul>
                    ...
                    <li><a class="seperator" href="#">/</a></li>
                     <li> <a href="#" class="ds_negevation_inactive Pactive">Punishment</a></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:TabContainer ID="tc1" runat="server" CssClass="fancy fancy-green" AutoPostBack="true" OnActiveTabChanged="tc1_ActiveTabChanged" ActiveTabIndex="0">
                                ...
                                <asp:TabPanel runat="server" ID="tab2" TabIndex="1" HeaderText="Other's Pay" Visible="false">
                                    <ContentTemplate>
                                ...
                                <asp:TabPanel runat="server" ID="tab3" TabIndex="1" HeaderText="Driver's Night Bill" Visible="false">
                                    <ContentTemplate>
                                        <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                                          ...
                                          <table class="em_personal_info_table">
                                              <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlCompanyList3" runat="server"  ClientIDMode="Static" OnSelectedIndexChanged="ddlCompanyList3_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control select_width" >
                                            </asp:DropDownList>
                                                </td>
                                            </tr>
                                              <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList runat="server" ID="ddlEmpCardNo3" ClientIDMode="Static" AutoPostBack="false" CssClass="form-control select_width"></asp:DropDownList>
                                                </td>
                                            </tr>                                           
                                            ...
                                            <tr >
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="txtNightBillMonth" runat="server" ClientIDMode="Static" CssClass="form-control text_box_width"  ></asp:TextBox>
 <asp:CalendarExtender ID="CalendarExtender1" Format="MM-yyyy" runat="server" TargetControlID="txtNightBillMonth"></asp:CalendarExtender>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="txtNightBillDays" runat="server" ClientIDMode="Static" CssClass="form-control text_box_width"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:TextBox ID="txtNightBillAmount" runat="server" ClientIDMode="Static" CssClass="form-control text_box_width"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:Button ID="btnNew3" Class="Pbutton" runat="server" Text="New" />
                                                </th>                                       

                                                <th>
                                                    <asp:Button ID="btnSave3" CssClass="Pbutton" ClientIDMode="Static" runat="server" Text="Save" OnClick="btnSave3_Click" />
                                                </th>

                                                <th>
                                                    <asp:Button ID="btnClose3" Class="Pbutton" runat="server" Text="Close" PostBackUrl="~/personnel_defult.aspx" /></th>

                                            </tr>
                                        </table>
                                        <asp:GridView runat="server" ID="gvNightBill" CssClass="gvdisplay1" DataKeyNames="SL,CompanyId,EmpId" AutoGenerateColumns="false" HeaderStyle-BackColor="#ffa500" HeaderStyle-Height="28px" HeaderStyle-ForeColor="White" PageSize="25" Width="100%" OnRowCommand="gvNightBill_RowCommand" >
                                            <Columns>
                                                <asp:BoundField DataField="CompanyName" HeaderText="Company" ItemStyle-HorizontalAlign="Center" />
                                                 <asp:BoundField DataField="EmpCardNo" HeaderText="Card No" ItemStyle-HorizontalAlign="Center" />
                                                 <asp:BoundField DataField="EmpName" HeaderStyle-HorizontalAlign="Left" HeaderText="Name" />
                                                 <asp:BoundField DataField="Month" HeaderText="Month" ItemStyle-HorizontalAlign="Center"/>
                                                 <asp:BoundField DataField="NightAllowDays" HeaderText="Day(s)" ItemStyle-HorizontalAlign="Center"/>
                                                 <asp:BoundField DataField="NightAllowAmount" HeaderText="Amount" ItemStyle-HorizontalAlign="Center"/>                                                 
                                                <asp:TemplateField HeaderText="Edit">
                                                <ItemTemplate>
                                                <asp:LinkButton ID="lnkAlter" runat="server" CommandName="Alter" CommandArgument="<%#((GridViewRow)Container).RowIndex%>" Text="Edit" Font-Bold="true" ForeColor="Green" ></asp:LinkButton>
                                                </ItemTemplate>
