        ...
        <div>
            ...
            <asp:GridView runat="server" ID="gvBannFord" AutoGenerateColumns="false" CssClass="table" OnRowDataBound="gvBannFord_RowDataBound">
                <Columns>
                   ...
                   <asp:BoundField DataField="OrginalAmount" HeaderText="Net Salary" ItemStyle-Width="150" />
                   <asp:BoundField DataField="EmpNetGross" HeaderText="Basic Salary" ItemStyle-Width="150" />
